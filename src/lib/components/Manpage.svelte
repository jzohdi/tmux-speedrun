...
>
	...
	<section class="manpage-section">
		...
		<p class="section-body indented">
			<span class="bold">tmux</span> is a terminal multiplexer: it enables a number of terminals to
			be created, accessed, and controlled from a single screen. <span class="bold">tmux</span> may be
		...
		<p class="section-body indented">
			A session is a single collection of <span class="underline">pseudo terminals</span> under the
			management of <span class="bold">tmux</span>. Each session has one or more windows linked to
			it. A window occupies the entire screen and may be split into rectangular panes, each of which
			is a separate pseudo terminal (the pty(4) manual page documents the technical details of
			pseudo terminals). Any number of <span class="bold">tmux</span> instances may connect to the
			same session, and any number of windows may be present in the same session. Once all sessions
			are killed, <span class="bold">tmux</span> exits.
		</p>
		<p class="section-body indented">
		...
		<p class="section-body indented">
			...
			and all sessions are managed by a single <span class="underline">server</span>. The server and
			each client are separate processes which communicate through a socket in /tmp.
		</p>
	</section>
	...
	<section class="manpage-section">
		...
		<p class="section-body indented">
			A pane may be entered into copy mode with 'C-b ['. This allows text to be copied from the pane
			history and is also used for scrolling. Copy mode uses vi-style key bindings by default.
		</p>
	</section>
